...
$fieldsOrder = ['jform[contact_spacer]','jform[contact_name]', 'jform[contact_telephone]', 'jform[contact_email]','jform[contact_subject]','jform[contact_message]','jform[contact_email_copy]'];
        ...
        <?php foreach ($this->form->getFieldsets() as $fieldset) : ?>
            ...
            <?php if (count($fields)) : ?>
                <fieldset class="m-0">
                   ...
                   <?php
				      foreach ($fieldsOrder as $rightField) { 
					      foreach ($fields as $field)
						     if ($field->name === $rightField)
